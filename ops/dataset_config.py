...
# ROOT_DATASET =r'/home/yong-group/文档/RWF-2000'
# ROOT_DATASET =r'/media/yong-group/新加卷/violence5000'
# ROOT_DATASET =r'/media/yong-group/4CC89650C89637E2/dataset/hockey'
# ROOT_DATASET =r'/media/yong-group/4CC89650C89637E2/dataset/movies'
# ROOT_DATASET =r'/media/yong-group/4CC89650C89637E2/dataset/RWF-2000'
# ROOT_DATASET =r'D:\RWF-2000'

ROOT_DATASET =r'/mnt/data-windows/jjz/RWF-2000/'
# ROOT_DATASET =r'/mnt/data-windows/jjz/movies/'
# ROOT_DATASET =r'/mnt/data-windows/jjz/HockeyFights/'


# ... (在 return_HockeyFights 函数之后)


def return_CrowdViolence(modality):
    # 类别文件
    filename_categories = 'category.txt'
    
    if modality == 'RGB':
        # 根目录直接使用 ROOT_DATASET
        root_data = ROOT_DATASET
        # 训练和验证列表文件
        filename_imglist_train = r'train_videofolder.txt'
        filename_imglist_val = r'val_videofolder.txt'
        # 图片前缀，根据你的实际图片命名修改，通常是 {:05d}.jpg 或 img_{:05d}.jpg
        prefix = '{:05d}.jpg' 
    else:
...
def return_RWF2000(modality):
    filename_categories = 'category.txt'
    if modality == 'RGB':
        # 假设 RWF-2000 数据也在 ROOT_DATASET 指向的目录下
        root_data = ROOT_DATASET
        filename_imglist_train = r'train_videofolder.txt'
        filename_imglist_val = r'val_videofolder.txt'
        prefix = '{:05d}.jpg' # 根据你的实际图片命名格式调整
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix

# ... (下面是 return_ucf101 等其他函数)
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'HockeyFights': return_HockeyFights, 'RWF-2000': return_RWF2000, 'CrowdViolence': return_CrowdViolence}
