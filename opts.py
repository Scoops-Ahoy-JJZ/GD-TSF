...
parser.add_argument('--dataset', type=str, default="RWF-2000" )#HockeyFights#CrowdViolence#RWF-2000
...
# parser.add_argument('--arch', type=str, default="ghostnetv2")
...
# parser.add_argument('--tune_from', type=str, default='./pretrained/state_dict_73.98.pth", help='fine-tune from checkpoint')
# parser.add_argument('--turn_from',type=str,default='', help='fine-tune from checkpoint')
